...
class SyncService extends DB {
    ...
    def aggregateGeofenceData(appId: String): Map[String, Map[(String, String), Int]] = {
    ...
    def aggregateVisitsPerHourOfDay(appId: String): Map[String, Map[Int, Int]] = null
    ...
    def aggregateDwellTime(appId: String): Map[String, CountStats] = null

    /*geofenceEventDao.aggregate(appIdFilter(appId), dwellTime, dwellTimeAvg).results("geofenceId", "dwellTime")*/

    def aggregateVisitsPerVisitor(appId: String): Map[String, CountStats] = null
